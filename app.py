...
def index():
    if request.method == 'POST':
        ...
        r = requests.get('https://api.openweathermap.org/data/2.5/weather?q='+city_name+'&appid=5f57fee2d093b34dfdc56503da9d71d2')

        #read the json object
        json_object = r.json()

     
        temperature = int(json_object['main']['temp']-273.15) #convert the tempreature from kelvin to c
